    ...
    public class RomanNumeral
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (command != 3)
            {
                ...
                Console.WriteLine("1. Convert integer to roman numeral");
                Console.WriteLine("2. Convert roman numeral to integer");
                ...
                if (command == 1)
                {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine($"Numeral: {new RomanNumeral(choice).ToString()}");
                    }
                    catch (Exception ex)
                    {
                ...
                if (command == 2)
                {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine($"Integer: {RomanNumeral.Parse(choice).Number}");
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine($"Exception: {ex}");
            ...
            //Console.WriteLine(new RomanNumeral(4999).ToString());
            //Console.WriteLine(RomanNumeral.Parse("S").Number);
        }
        ...
        public RomanNumeral(int number)
        {
            ...
            if(number > 4999)
            {
                throw new ArgumentOutOfRangeException(nameof(number), "Number should be under 5000");
            }
